...
def populate_database():
    ...
    # Feel free to add voters to the voter registry, and issue ballots
    all_voters = [
    ...
    for voter in all_voters:
        ...
        print(
            f"Voter {voter.first_name} {voter.last_name} [{voter.national_id}] has ballot_number {ballot_number}")
